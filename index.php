    ...
    <section class="categories">
     <div class="container">
      <h2 class="text-center text-white">Explore Various Food Categories</h2>
      ...
      <div class="food-menu-container">
       ...
       <div class="food-menu-box">
        ...
        <div class="food-menu-desc">
         ...
         <a href="<?php echo SITEURL; ?>order.php?food_id=<?php echo $id; ?>" class="order-now bg-dark">Order Now</a>
        </div>
       </div>
